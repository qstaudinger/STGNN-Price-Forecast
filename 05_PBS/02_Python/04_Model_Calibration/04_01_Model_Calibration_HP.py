...
def sample_hyperparams(
    ...
    win_hour_choices = [4, 6, 8]
    
    #win_day_choices  = [8, 16, 32, 64, 96]
    #win_week_choices = [96, 192, 288, 480, 672]
    #length_encoder_choices = [12, 16, 32]
    length_encoder = int(rng.choice([12, 16, 32]))
    win_day_candidates = [8, 16, 32, 64, 96]
...
def main():
    ...
    #, map_location="cpu"
    data = STWindowDataMulti(**blob)   # Klasse muss dann halt definiert/importiert sein
